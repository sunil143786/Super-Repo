...
premium = environ.get('PREMIUM_LOGS', '-1002440337557')
...
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1001883539506'))
NO_RESULTS_MSG = is_enabled((environ.get("NO_RESULTS_MSG", 'True')), False)

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Bisalrepo:Bisalrepo@cluster0.tp6ng.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002440337557))
GROUP_VERIFY_LOGS = int(environ.get('GROUP_VERIFY_LOGS', -1002440337557)) # Group verify stats 
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1002440337557)) # movies request channel, else log channel
...
# Streaming
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002440337557")
